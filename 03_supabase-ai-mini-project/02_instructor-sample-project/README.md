...
```powershell
cd C:\aidev\03_supabase-ai-mini-project\02_instructor-sample-project\backend
...
```powershell
cd C:\aidev\03_supabase-ai-mini-project\02_instructor-sample-project\frontend
..\..\.venv\Scripts\Activate.ps1
