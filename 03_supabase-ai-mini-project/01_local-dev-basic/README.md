...
이 단원은 `01_supabase-ai-backend`와 `02_supabase-ai-frontend`에서 배운 실행 방식을 하나로 연결하는 준비 단계입니다.
...
즉, `C:\aidev\.env`, `01_supabase-ai-backend\.env`, `02_supabase-ai-frontend\.env`를 사용하는 구조가 아닙니다. 각 과정은 자기 폴더의 `.env`를 기준으로 실행합니다.
