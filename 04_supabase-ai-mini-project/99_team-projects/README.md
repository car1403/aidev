...
- API 설계 문서, 화면 설계서, 데이터베이스 스키마 설계서, 대시보드 구현 결과 문서가 작성됩니다.

선택 확장:

- 프로젝트 계획서, 테스트 체크리스트, 발표 자료
- SSE 기반 실시간 응답 표시
- Gemini 기반 AI 응답 저장
- 사용자 피드백 기반 품질 개선 지표
...
2. 필요하면 선택 보조 문서인 `docs/project-plan.md`에 프로젝트 주제와 사용자를 정리합니다.
