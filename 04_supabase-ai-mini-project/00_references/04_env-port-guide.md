...
이 문서는 04 과정에서 사용하는 환경변수와 포트 번호를 초보자 기준으로 설명합니다.
...
| `GEMINI_API_KEY` | Backend | 04 과정의 기본 AI API 호출용 key |
...
04 과정에서 FastAPI와 Streamlit은 로컬 PC에서 실행됩니다. 백엔드 주소는 보통 다음 값을 사용합니다.
