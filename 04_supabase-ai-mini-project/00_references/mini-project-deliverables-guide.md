...
이 문서는 `04_supabase-ai-mini-project`의 필수 산출물을 작성할 때 참고하는 가이드입니다.
...
필수 산출물은 위 4가지입니다. 프로젝트 계획서, 테스트 체크리스트, SSE 설계서, 배포 가이드, 발표 자료는 팀 상황에 따라 작성하는 선택 보조 산출물입니다.
