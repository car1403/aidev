...
04 과정에서는 프로젝트를 로컬 Python 실행 방식으로 진행합니다.
...
04 과정에서는 Supabase, FastAPI, Streamlit을 로컬 Python 방식으로 연결합니다.

Docker, Docker Compose, AWS, GitHub Actions, 운영 모니터링은 `07_multi-agent-service-ops`에서 서비스 운영 관점으로 학습합니다.

즉, 04 과정의 목표는 “운영 환경 구성”이 아니라 “서비스 기능이 실제로 연결되는 구조를 이해하고 구현하는 것”입니다.
