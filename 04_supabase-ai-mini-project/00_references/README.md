...
04 과정은 Supabase, FastAPI, Streamlit을 연결해 실시간 로그 대시보드 형태의 미니 프로젝트를 완성하는 과정입니다. Docker, Docker Compose, AWS 배포, GitHub Actions 자동화는 이 과정에서 필수로 진행하지 않고 `07_multi-agent-service-ops`에서 다룹니다.

## 먼저 확인할 기준

04 과정의 최종 프로젝트는 아래 구조를 기준으로 진행합니다.
...
1. [README.md](../README.md)에서 04 과정의 목표와 산출물을 확인합니다.
