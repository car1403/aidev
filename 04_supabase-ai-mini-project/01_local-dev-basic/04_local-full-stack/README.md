...
이 실습은 `02_supabase-ai-backend`에서 배운 Supabase 저장 흐름과 `03_supabase-ai-frontend`에서 배운 Streamlit API 호출 흐름을 하나로 연결합니다.
...
cd C:\aidev\04_supabase-ai-mini-project\01_local-dev-basic\04_local-full-stack\backend
...
cd C:\aidev\04_supabase-ai-mini-project
.\.venv\Scripts\Activate.ps1
cd C:\aidev\04_supabase-ai-mini-project\01_local-dev-basic\04_local-full-stack\frontend
...
- Docker 기반 실행은 이 실습에서 하지 않고 `07_multi-agent-service-ops`에서 학습합니다.
