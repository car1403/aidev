...
이 실습은 `04_supabase-ai-mini-project` 최상위 `.venv`와 `.env`를 사용합니다. `backend` 폴더 안에 `.venv`를 새로 만들지 않습니다.
...
cd C:\aidev\04_supabase-ai-mini-project\01_local-dev-basic\02_local-fastapi\backend
