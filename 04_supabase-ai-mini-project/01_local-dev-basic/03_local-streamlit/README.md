...
이 실습도 `04_supabase-ai-mini-project` 최상위 `.venv`를 사용합니다. `frontend` 폴더 안에 `.venv`를 새로 만들지 않습니다.
...
cd C:\aidev\04_supabase-ai-mini-project\01_local-dev-basic\03_local-streamlit\frontend
