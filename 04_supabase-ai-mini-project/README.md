...
3. Redis와 SSE 기반 실시간 데이터 시각화 대시보드 구현
...
2. [00_references](./00_references/README.md)에서 프로젝트 목표와 DB/Redis/SSE 역할을 확인합니다.
3. [01_supabase-and-sse-practice](./01_supabase-and-sse-practice/README.md)에서 작은 실시간 로그 예제를 실행합니다.
