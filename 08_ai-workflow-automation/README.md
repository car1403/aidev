...
학생들은 코드를 많이 작성하기보다, 업무 흐름을 `Trigger`, `Condition`, `Action`, `LLM`, `Tool`, `Memory`, `Log` 구조로 나누고 이를 실제 도구 화면에 옮기는 방법을 학습합니다.
...
Dify는 초보자 수업에서는 Cloud 또는 강사가 준비한 실습 환경을 먼저 사용하는 것을 권장합니다.
