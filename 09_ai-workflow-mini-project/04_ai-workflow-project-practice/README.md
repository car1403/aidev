...
이 폴더의 문서는 팀 프로젝트를 바로 구현하기 전에, 수업 참여자가 먼저 생각을 정리하도록 돕는 설계 연습 자료입니다. 강의에서는 이 문서를 하나씩 작성한 뒤 `99_team-projects`의 팀 템플릿으로 옮겨가면 좋습니다.
...
수업 참여자에게 처음부터 완벽한 구현을 요구하지 않아도 됩니다. 먼저 아래 질문에 답하게 하면 프로젝트 방향이 빠르게 정리됩니다.
