...
- 최종 응답 생성
- Streamlit 화면 출력
- 에이전트 아키텍처 설계서와 에이전트 시험 결과 보고서 작성
...
5. 최종 응답 생성
6. Streamlit 화면 연결
7. 에이전트 아키텍처 설계서와 에이전트 시험 결과 보고서 작성
...
선택 확장은 필수 기능이 아닙니다. 프로젝트 시간이 부족하면 Mock data, Tool, LangGraph, Streamlit UI, 에이전트 아키텍처 설계서, 에이전트 시험 결과 보고서까지만 완성해도 좋습니다.
