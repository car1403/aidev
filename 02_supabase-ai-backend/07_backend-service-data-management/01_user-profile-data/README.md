...
`06_supabase-db-and-auth`에서는 Supabase 프로젝트, 테이블 생성, CRUD, Auth/RLS, Upstash Redis의 기본 흐름을 배웠습니다. 이번 챕터부터는 그 내용을 실제 백엔드 서비스 데이터 구조로 연결합니다.
...
`06_supabase-db-and-auth/00_references/supabase-schema.sql`에는 아래 기본 구조가 포함되어 있습니다.
