...
앞 단원인 `02_llm-api-integration`에서는 실제 프로젝트 기본 LLM 호출 방식을 Gemini SDK로 정리했습니다. 이 과제에서는 실제 호출을 필수로 하지 않지만, mock 응답과 Gemini SDK 응답을 같은 테이블 구조로 저장할 수 있도록 설계해야 합니다.
