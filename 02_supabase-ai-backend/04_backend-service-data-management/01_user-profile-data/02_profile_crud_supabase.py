...
실행 전 확인할 것:
1. C:\\aidev\\02_supabase-ai-backend\\.env 파일에 Supabase 값이 들어 있어야 합니다.
2. Supabase SQL Editor에서 03_supabase-db-and-auth/00_references/supabase-schema.sql을 실행해야 합니다.
...
# 현재 파일 위치:
# C:\aidev\02_supabase-ai-backend\04_backend-service-data-management\01_user-profile-data\02_profile_crud_supabase.py
# parents[2]는 C:\aidev\02_supabase-ai-backend 폴더입니다.
