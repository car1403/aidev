...
```text
C:\aidev\02_supabase-ai-backend\08_backend-mini-service-practice 폴더 구조를 설명해 주세요.
...
```text
C:\aidev\02_supabase-ai-backend\08_backend-mini-service-practice\04_implementation-guide\main_mock.py의 실행 흐름을 설명해 주세요.
