...
| 위치 | 어떤 파일 또는 폴더인지 | `01_fastapi-backend/01_fastapi-project-setup/main.py` |
...
```text
C:\aidev\02_supabase-ai-backend\05_backend-mini-service-practice 폴더 구조를 설명해 주세요.
...
## 01_python-git-foundation/03_git-github와의 역할 구분

`01_python-git-foundation/03_git-github`는 Git과 GitHub를 중심으로 다룹니다.
...
```text
C:\aidev\02_supabase-ai-backend\05_backend-mini-service-practice\04_implementation-guide\main_mock.py의 실행 흐름을 설명해 주세요.
...
- Git/GitHub 학습은 `01_python-git-foundation/03_git-github`, AI 기반 코드 리뷰와 디버깅은 `90_ai-assisted-code-review-and-debugging`에서 다룬다는 역할 구분
