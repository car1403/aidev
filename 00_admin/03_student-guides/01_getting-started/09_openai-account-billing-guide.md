...
2. 유료 플랜이 필요한 경우 수업 또는 기관 안내를 따릅니다.
...
개인 카드로 결제해야 하는 상황이라면, 결제 전에 진행자에게 먼저 확인하는 것이 좋습니다.
...
2. 유료 기능이 필요한 경우 데모 계정 또는 기관 계정을 준비해 사용할 수 있습니다.
3. 개인 결제가 필요한 경우 사전에 별도로 안내합니다.
