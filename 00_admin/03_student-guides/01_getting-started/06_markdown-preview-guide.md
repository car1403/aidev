...
이 수업의 설명서, 실습 안내, 과제 제출 문서, 발표 자료 초안은 대부분 Markdown으로 작성되어 있습니다. 학생은 코드를 실행하기 전에 먼저 README를 Preview로 읽고, 프로젝트를 진행하면서 직접 Markdown 문서를 작성할 수 있어야 합니다.
...
```markdown
![이미지 설명](images/screen-01.png)
```

예시:

```markdown
![VS Code Preview 화면](images/vscode-preview.png)
```
...
수업 문서에서는 주의사항, 팁, 강사 메모에 사용할 수 있습니다.
