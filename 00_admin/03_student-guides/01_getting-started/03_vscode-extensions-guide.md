...
```text
README.md를 GitHub 화면처럼 깔끔하게 보고 싶은 학생
복잡한 설정 없이 문서를 편하게 읽고 싶은 학생
```
...
```text
Markdown 문서 안에서 다이어그램, 수식, 고급 Preview 기능을 사용하고 싶은 학생
문서 작성 기능을 더 강하게 사용하고 싶은 학생
```
...
처음 수업에서는 Codex App을 먼저 사용하고, 강사가 안내하는 시점에 VS Code Codex 확장을 설치해도 됩니다.
