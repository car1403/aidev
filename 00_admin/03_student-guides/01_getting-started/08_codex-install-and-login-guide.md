...
중요한 점은 Codex가 모든 것을 대신해 주는 도구가 아니라, 학생이 코드를 이해하고 더 잘 실습하도록 돕는 학습 파트너라는 점입니다.

## 1. 수업에서 Codex를 사용하는 이유

학생은 Codex를 다음 용도로 사용할 수 있습니다.
...
초보자 수업에서는 Python과 VS Code를 먼저 준비하고, Git, Node.js, GitHub CLI는 강사가 필요하다고 안내할 때 설치해도 됩니다.
...
학생 입장에서는 Git을 설치하면 아래 작업을 할 수 있습니다.
...
학생 입장에서는 Node.js를 설치하면 아래 작업을 할 수 있습니다.
...
학생 입장에서는 Python을 설치하면 아래 작업을 할 수 있습니다.
...
학생 입장에서는 GitHub CLI를 설치하면 아래 작업을 할 수 있습니다.
...
수업에서 학생에게 안내할 때는 아래처럼 말하면 좋습니다.
...
특히 학생 개인 카드로 결제할 때는 강사에게 먼저 확인하는 것이 좋습니다.
