...
Python은 이 수업에서 가장 기본이 되는 실행 도구입니다.

01~03 과정에서는 Python으로 FastAPI, Streamlit, Supabase 연동을 실행합니다. 04~09 과정에서도 Python 예제와 AI 서비스 코드를 계속 사용합니다.
