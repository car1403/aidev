...
이 단원은 특정 기술 스택보다 학습 방식과 개발 습관에 초점을 둡니다. 수업 참여자는 Codex에게 코드를 대신 맡기는 것이 아니라, 요구사항을 명확히 설명하고, 결과를 검토하고, 오류를 함께 해결하는 방식으로 AI 보조 개발을 연습합니다.
...
수업 참여자에게 강조할 점은 “AI 답변을 많이 받는 것”이 아니라 “답변을 검증하고 내 코드에 맞게 적용하는 것”입니다.
