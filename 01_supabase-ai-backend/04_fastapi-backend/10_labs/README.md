...
이 폴더는 `04_fastapi-backend` 단원에서 수업 중 함께 진행하는 실습 모음입니다.
...
| 99 | `lab-99_mini-memo-api-server` | `04_fastapi-backend 마무리` | 작은 메모 API 서버 완성 |

## 공통 실행 방법

가상환경은 `01_supabase-ai-backend` 폴더의 `.venv`를 사용합니다.
