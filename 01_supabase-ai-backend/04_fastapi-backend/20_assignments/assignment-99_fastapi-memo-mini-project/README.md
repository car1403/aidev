...
이 과제는 이후 `05_llm-api-integration`, `06_supabase-db-and-auth`, `02_supabase-ai-frontend`, `03_supabase-ai-mini-project`로 이어지는 기반입니다. 여기서는 Supabase에 저장하지 않고 서버 메모리 dict에 저장합니다.
...
```powershell
cd C:\aidev\01_supabase-ai-backend\04_fastapi-backend\20_assignments\assignment-99_fastapi-memo-mini-project
