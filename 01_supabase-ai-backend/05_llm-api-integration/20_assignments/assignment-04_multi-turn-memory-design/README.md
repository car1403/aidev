# Assignment 04. Multi-turn 대화 이력 설계

AI 챗봇은 사용자의 이전 질문과 AI의 이전 답변을 참고해야 자연스럽게 이어지는 답변을 만들 수 있습니다.

이 과제에서는 대화 이력을 리스트로 관리하고, 최근 메시지를 LLM 요청 구조로 변환하는 코드를 작성합니다.
...
python .\05_llm-api-integration\20_assignments\assignment-04_multi-turn-memory-design\main.py
```
