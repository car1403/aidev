...
# 이 파일은 다음 위치에 있습니다.
# 01_supabase-ai-backend/06_supabase-db-and-auth/01_supabase-project-and-env/01_check_supabase_env.py
...
def main() -> None:
    ...
    if not (url_ok and anon_ok and service_role_ok):
        ...
        print("3. C:\\aidev\\01_supabase-ai-backend\\.env 파일에 값을 입력합니다.")
        return
