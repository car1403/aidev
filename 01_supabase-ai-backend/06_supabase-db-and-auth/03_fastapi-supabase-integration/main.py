...
# 이 파일은 다음 위치에 있습니다.
# 01_supabase-ai-backend/06_supabase-db-and-auth/03_fastapi-supabase-integration/main.py
...
def read_required_env(name: str) -> str:
    ...
    if value is None or not value.strip():
        raise HTTPException(
            ...
            detail=f"{name} is missing. Check C:\\aidev\\01_supabase-ai-backend\\.env.",
        )
