...
```text
C:\aidev\01_supabase-ai-backend\06_supabase-db-and-auth\10_labs
```
...
```text
C:\aidev\01_supabase-ai-backend\06_supabase-db-and-auth\90_legacy-docker-postgresql-redis-reference
```
