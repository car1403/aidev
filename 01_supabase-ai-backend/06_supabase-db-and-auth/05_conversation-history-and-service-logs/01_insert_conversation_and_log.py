...
# 이 파일은 다음 위치에 있습니다.
# 01_supabase-ai-backend/06_supabase-db-and-auth/05_conversation-history-and-service-logs/01_insert_conversation_and_log.py
# parents[2]는 01_supabase-ai-backend 폴더입니다.
...
def get_required_env(name: str) -> str:
    ...
    if value is None or not value.strip():
        raise RuntimeError(f"{name} 값이 없습니다. C:\\aidev\\01_supabase-ai-backend\\.env 파일을 확인하세요.")
...
def print_supabase_setup_help(error: APIError) -> None:
    ...
    print("2. 06_supabase-db-and-auth/00_references/supabase-schema.sql 내용을 실행합니다.")
