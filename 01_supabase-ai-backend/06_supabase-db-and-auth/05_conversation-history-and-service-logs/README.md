...
2. `06_supabase-db-and-auth/00_references/supabase-schema.sql` 파일 내용을 복사합니다.
...
| `02_supabase-ai-frontend` | Streamlit 화면에서 대화 이력 조회 |
| `03_supabase-ai-mini-project` | 실시간 로그 대시보드와 최종 프로젝트 |
