...
9. .gitignore와 .env 보안 기준 확인
10. 커밋 메시지 작성 원칙 학습
11. Codex로 diff 설명과 README 개선 요청
12. 개인 과제 제출
```
...
이 README가 학생용 수업 문서로 충분한지 검토해 주세요.
이 변경 내용에 민감정보가 포함되어 있는지 점검해 주세요.
이 과제 설명을 학생들이 이해하기 쉽게 다시 작성해 주세요.
```
...
학생은 이 단원이 끝났을 때 아래 내용을 스스로 설명할 수 있어야 합니다.
