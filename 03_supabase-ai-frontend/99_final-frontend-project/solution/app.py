...
with st.sidebar:
    ...
    with st.form("signup_form"):
        signup_email = st.text_input("회원가입 이메일")
        signup_name = st.text_input("표시 이름")
        signup_password = st.text_input("회원가입 비밀번호", type="password")
    ...
    with st.form("signin_form"):
        signin_email = st.text_input("로그인 이메일")
        signin_password = st.text_input("로그인 비밀번호", type="password")
