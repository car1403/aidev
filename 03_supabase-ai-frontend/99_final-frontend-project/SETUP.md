...
```powershell
cd C:\aidev\03_supabase-ai-frontend\99_final-frontend-project
```

## 2. 상위 과정 가상환경 활성화

이 실습은 `03_supabase-ai-frontend`의 `.venv`를 함께 사용합니다.
...
즉, `C:\aidev\.env` 또는 `C:\aidev\03_supabase-ai-frontend\.env`를 사용하는 구조가 아닙니다.
...
cd C:\aidev\03_supabase-ai-frontend
.\.venv\Scripts\Activate.ps1
cd C:\aidev\03_supabase-ai-frontend\99_final-frontend-project\backend
...
cd C:\aidev\03_supabase-ai-frontend
.\.venv\Scripts\Activate.ps1
cd C:\aidev\03_supabase-ai-frontend\99_final-frontend-project\frontend
