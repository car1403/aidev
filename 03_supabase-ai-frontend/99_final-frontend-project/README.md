...
`99_final-frontend-project`는 `03_supabase-ai-frontend`의 마지막 실습입니다.
...
이 실습은 운영 자동화 과정이 아닙니다. Docker, Docker Compose, AWS, GitHub Actions 기반 운영 자동화는 `07_multi-agent-service-ops`에서 더 깊게 다룹니다.
...
- 이 예제를 `04_supabase-ai-mini-project`의 팀 프로젝트로 확장하는 방법을 이해합니다.
...
이 폴더는 `04_supabase-ai-mini-project`의 축소판입니다.
