...
| 막히는 지점 | 확인 문서 |
| --- | --- |
| Streamlit 실행 오류 | [Streamlit 오류 해결](../00_course-guide/02_learning-guide/troubleshooting.md), [SETUP.md](./SETUP.md) |
| 백엔드 연결 실패 | [03 Frontend SETUP](./SETUP.md), [FastAPI 오류 해결](../00_course-guide/02_learning-guide/troubleshooting.md) |
| `API_BASE_URL` 또는 `.env` 위치가 헷갈림 | [SETUP.md](./SETUP.md), [환경과 오류 해결 허브](../00_course-guide/02_learning-guide/troubleshooting.md) |
| service role key를 프론트엔드에 넣어도 되는지 헷갈림 | [Supabase 오류 해결](../00_course-guide/02_learning-guide/troubleshooting.md), [02 Backend SETUP](../02_supabase-ai-backend/SETUP.md) |
