...
C:\aidev\02_supabase-ai-backend\07_backend-service-data-management\03_service-logs
```
...
```powershell
cd C:\aidev\03_supabase-ai-frontend\05_state-session-and-data\00_references
..\..\.venv\Scripts\Activate.ps1
