...
이 폴더는 07 미니 프로젝트를 시작하기 전에 로컬 실행 환경을 확인하는 단계입니다.

07은 Docker Compose로 여러 서비스를 동시에 실행합니다. 따라서 프로젝트 코드를 수정하기 전에 Docker Desktop, Docker Compose, Health Check 확인 흐름을 먼저 익히는 것이 중요합니다.
...
처음에는 명령을 외우는 것보다 “무엇을 확인하는 명령인지”를 이해하는 것이 더 중요합니다.
