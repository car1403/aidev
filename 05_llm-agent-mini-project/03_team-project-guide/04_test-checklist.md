...
- [ ] Agent State 필드와 타입 힌트가 정의되어 있습니다.
- [ ] State 필드에 `messages`, `tools_called`, `error_count`, `iteration` 등 필요한 값이 중복 없이 정리되어 있습니다.
...
- [ ] End Node에서 최종 답변이 생성됩니다.
- [ ] fallback 흐름이 edge 또는 node로 구현되어 있습니다.
- [ ] Session Memory, Long-term Memory, 컨텍스트 요약 전략 적용 여부가 설명되어 있습니다.
