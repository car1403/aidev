...
Python 기초, Python 심화, Git/GitHub, VS Code Source Control, 민감정보 보호 기준
```
...
-> 예외 처리와 테스트
-> Git 변경 이력 관리
-> GitHub와 VS Code Source Control 사용
```

## 02~04 Supabase 기반 AI 서비스

```text
02_supabase-ai-backend
FastAPI, Gemini 2.5 Flash-Lite 기본 호출, Supabase 저장, Auth/RLS, 대화 이력, Upstash Redis 개념
...
05에서 배운 내용을 바탕으로 Agent 미니 프로젝트를 만듭니다.
```
