...
이 단원은 AI 서비스 운영 상태를 확인하기 위한 로그, 이벤트 이력, tracing, 운영 대시보드를 학습합니다.
...
LangSmith는 Agent 실행 추적을 돕는 도구입니다. 이 단원에서는 먼저 Mock trace와 로컬 로그로 구조를 이해하고, 실제 LangSmith 연동은 선택 확장으로 둡니다.
