...
```text
1. 테스트 대상 함수를 만들 수 있습니다.
2. pytest 테스트 파일을 작성할 수 있습니다.
3. assert로 예상 결과와 실제 결과를 비교할 수 있습니다.
4. pytest.raises로 오류 발생을 테스트할 수 있습니다.
5. 응답 dict에 필요한 key가 있는지 확인할 수 있습니다.
```
