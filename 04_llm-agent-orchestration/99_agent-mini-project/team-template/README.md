...
이 폴더는 학생 팀이 최종 Agent 미니 프로젝트를 시작할 때 사용하는 템플릿입니다.

샘플 프로젝트를 그대로 복사하기보다, 팀이 해결할 문제에 맞게 State, Tool, Graph 흐름을 다시 설계하는 것이 목표입니다.
...
6. Retry, Fallback, Reflection 전략을 정합니다.
7. CLI에서 먼저 실행합니다.
