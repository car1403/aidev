...
├─ 04_mcp-concept-and-optional-practice
│  ├─ README.md
...
이 단원의 `.env`는 `C:\aidev\04_llm-agent-orchestration\04_function-calling-and-tool-use\.env` 파일입니다.
...
python .\04_mcp-concept-and-optional-practice\01_mcp-concept-summary.py
```
...
| `04_mcp-concept-and-optional-practice` | Function Calling과 MCP는 어떤 문제를 해결하려는가? |
