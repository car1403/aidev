...
이 단원은 코드를 대신 생성시키는 수업이 아닙니다. 수업 참여자가 먼저 코드를 작성하고 실행한 다음, Codex 같은 AI 보조 도구를 사용해 문제를 찾고, 설명을 검토하고, 직접 수정하는 방법을 학습합니다.
...
1. 먼저 수업 참여자가 직접 코드를 작성합니다.
2. 실행 결과와 오류 메시지를 직접 확인합니다.
3. AI에게 질문할 때는 코드, 실행 명령, 기대 결과, 실제 결과를 함께 제공합니다.
4. AI 답변은 검토 자료로 사용하고 최종 수정은 수업 참여자가 직접 반영합니다.
