...
이 단원은 코드를 대신 생성시키는 수업이 아닙니다. 직접 먼저 코드를 작성하고 실행한 다음, Codex 같은 AI 보조 도구를 사용해 문제를 찾고, 설명을 검토하고, 직접 수정하는 방법을 학습합니다.
