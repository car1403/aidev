...
.\.venv\Scripts\Activate.ps1
streamlit run .\05_state-session-and-data\04_user-data-and-conversation-history\02_conversation-history-api.py
```
...
- Docker와 배포 환경은 `06_multi-agent-service-ops`에서 별도로 학습합니다.
