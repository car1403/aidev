...
이 문서는 `02_supabase-ai-frontend` 과정의 전체 흐름을 한눈에 보기 위한 참고 자료입니다.
...
`02_supabase-ai-frontend`는 독립적으로 완성되는 과정이 아닙니다. `01_supabase-ai-backend`에서 만든 API를 호출하면서 완성됩니다.
...
`03_supabase-ai-mini-project`에서는 01과 02에서 배운 내용을 묶어 통합 프로젝트를 진행합니다.
...
Docker Compose, AWS, GitHub Actions, 모니터링, Auto Healing은 `06_multi-agent-service-ops`에서 더 깊게 다룹니다.
