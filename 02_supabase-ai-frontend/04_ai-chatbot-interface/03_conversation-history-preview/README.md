...
사용자별 대화 이력, 로그인 상태, Supabase 저장, 서비스 로그는 `05_state-session-and-data`에서 본격적으로 다룹니다.
...
streamlit run .\04_ai-chatbot-interface\03_conversation-history-preview\02_append-chat-history.py
```
