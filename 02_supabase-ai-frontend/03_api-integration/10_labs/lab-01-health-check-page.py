...
st.title("Health Check 실습")  # Streamlit 화면의 가장 큰 제목을 표시합니다.

if st.button("서버 상태 확인"):  # 조건식이 True일 때만 아래 들여쓰기 블록을 실행합니다.
    try:  # 실패할 수 있는 코드를 실행하고, 오류가 나면 except 블록에서 처리합니다.
        ...
        st.error("FastAPI 서버를 먼저 실행하세요.")  # 오류 상황을 사용자에게 명확히 보여줍니다.
