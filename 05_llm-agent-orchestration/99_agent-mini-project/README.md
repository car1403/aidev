...
```powershell
cd C:\aidev\05_llm-agent-orchestration\99_agent-mini-project\sample-schedule-agent
python -m venv .venv
...
```powershell
cd C:\aidev\05_llm-agent-orchestration\99_agent-mini-project\team-template
python -m venv .venv
.\.venv\Scripts\Activate.ps1
python -m pip install --upgrade pip
