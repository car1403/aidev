...
| 막히는 지점 | 확인 문서 |
| --- | --- |
| OpenAI API key, 비용, 호출 제한 | [OpenAI 계정과 결제 안내](../00_course-guide/03_student-guides/01_getting-started/09_openai-account-billing-guide.md), [OpenAI 기본 호출](./01_llm-api-and-prompt-basics/01_openai-api-basic/README.md) |
| Docker Desktop 또는 `docker run` 오류 | [Docker 오류 해결](../00_course-guide/08_environment-and-troubleshooting/07_docker-errors-for-later-courses.md), [Docker Desktop 설치 안내](./00_references/09_docker-desktop-install-for-beginners.md) |
